...
export function Header() {
	...
	const links = [
		...
		{ label: "Chat", href: "#chat-preview" },
		{ label: "New", href: "#new features" },
		{ label: "Signup", href: "#signup" },
		{ label: "About", href: "#KnowMoreAboutMe" },
		{ label: "Comments", href: "#reviews" },
];
	...
	return (
		<header
			className={cn(
				'sticky top-0 z-50 w-full max-w-5xl mx-auto border-b border-transparent md:rounded-md md:border transition-all duration-300 ease-out',
				{
				// Style when slightly scrolled
				'bg-background/95 supports-[backdrop-filter]:bg-background/50 border-border backdrop-blur-lg shadow-md md:top-4 md:max-w-4xl':
					scrolled && !open,
		...
		>
			<nav
				className={cn(
					...
					{
					'h-16 px-6 md:h-14 md:px-4': scrolled, // shrink nav when scrolled
					'h-20 px-4 md:h-16 md:px-6': !scrolled, // default nav height
					}
				)}
			>
